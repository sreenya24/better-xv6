...
main(int argc, char *argv[])
{
  ...
  16:	83e50513          	addi	a0,a0,-1986 # 850 <malloc+0xf2>
  1a:	00000097          	auipc	ra,0x0
  1e:	68c080e7          	jalr	1676(ra) # 6a6 <printf>
    exit(0);
  22:	4501                	li	a0,0
  ...
  4a:	47d1                	li	a5,20
  4c:	00e7ff63          	bgeu	a5,a4,6a <main+0x6a>
    printf("Invalid priority (0-20)!\n");
  50:	00001517          	auipc	a0,0x1
  54:	82050513          	addi	a0,a0,-2016 # 870 <malloc+0x112>
  58:	00000097          	auipc	ra,0x0
  5c:	64e080e7          	jalr	1614(ra) # 6a6 <printf>
    exit(0);
  60:	4501                	li	a0,0
  62:	00000097          	auipc	ra,0x0
  66:	2a2080e7          	jalr	674(ra) # 304 <exit>
  }
  chpr(pid, priority);
  6a:	854a                	mv	a0,s2
  6c:	00000097          	auipc	ra,0x0
  70:	358080e7          	jalr	856(ra) # 3c4 <chpr>
  exit(0);
  74:	4501                	li	a0,0
...
stats(const char *n, struct stats *st)
{
 ...
 1d8:	170080e7          	jalr	368(ra) # 344 <open>
  if(fd < 0)
 1dc:	02054563          	bltz	a0,206 <stats+0x42>
 1e0:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 1e2:	85ca                	mv	a1,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 414:	4e050513          	addi	a0,a0,1248 # 8f0 <digits>
 418:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d4:	3c8c8c93          	addi	s9,s9,968 # 898 <malloc+0x13a>
 ...
 4e2:	412b8b93          	addi	s7,s7,1042 # 8f0 <digits>
 ...
 608:	28c98993          	addi	s3,s3,652 # 890 <malloc+0x132>
        while(*s != 0){
 60c:	85ee                	mv	a1,s11
