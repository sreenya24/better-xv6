...
ls(char *path)
{
  ...
  d0:	23513423          	sd	s5,552(sp)
  d4:	1480                	addi	s0,sp,608
  d6:	892a                	mv	s2,a0
  char buf[512], *p;
  int fd;
  struct dirent de;
 ...
 11a:	85aa                	mv	a1,a0
 11c:	dac42703          	lw	a4,-596(s0)
 120:	da442683          	lw	a3,-604(s0)
 124:	da841603          	lh	a2,-600(s0)
 ...
 142:	25813083          	ld	ra,600(sp)
 146:	25013403          	ld	s0,592(sp)
 14a:	24813483          	ld	s1,584(sp)
 14e:	24013903          	ld	s2,576(sp)
 152:	23813983          	ld	s3,568(sp)
 156:	23013a03          	ld	s4,560(sp)
 15a:	22813a83          	ld	s5,552(sp)
 15e:	26010113          	addi	sp,sp,608
 162:	8082                	ret
    fprintf(2, "ls: cannot open %s\n", path);
 164:	864a                	mv	a2,s2
 ...
 23e:	000907a3          	sb	zero,15(s2)
      if(stats(buf, &st) < 0){
 242:	da040593          	addi	a1,s0,-608
 246:	dc040513          	addi	a0,s0,-576
 24a:	00000097          	auipc	ra,0x0
 24e:	1d2080e7          	jalr	466(ra) # 41c <stats>
 ...
 262:	85aa                	mv	a1,a0
 264:	dac42703          	lw	a4,-596(s0)
 268:	da442683          	lw	a3,-604(s0)
 26c:	da841603          	lh	a2,-600(s0)
 270:	8552                	mv	a0,s4
...
stats(const char *n, struct stats *st)
{
 ...
 430:	170080e7          	jalr	368(ra) # 59c <open>
  if(fd < 0)
 434:	02054563          	bltz	a0,45e <stats+0x42>
 438:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 43a:	85ca                	mv	a1,s2
