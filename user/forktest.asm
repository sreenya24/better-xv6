...
forktest(void)
{
  ...
  3e:	43650513          	addi	a0,a0,1078 # 470 <chpr+0xc>
  ...
  68:	41c50513          	addi	a0,a0,1052 # 480 <chpr+0x1c>
  ...
  b8:	41c50513          	addi	a0,a0,1052 # 4d0 <chpr+0x6c>
  ...
  d4:	3d050513          	addi	a0,a0,976 # 4a0 <chpr+0x3c>
  ...
  ee:	3ce50513          	addi	a0,a0,974 # 4b8 <chpr+0x54>
...
stats(const char *n, struct stats *st)
{
 ...
 278:	170080e7          	jalr	368(ra) # 3e4 <open>
  if(fd < 0)
 27c:	02054563          	bltz	a0,2a6 <stats+0x42>
 280:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 282:	85ca                	mv	a1,s2
